...
export const Navigation = () => {
  ...
  return (
    <div>
        ...
        <div className="flex items-center gap-[12.8px]">
          ...
          >
            ...
            <textarea
              ...
              rows={1}
              className={`resize-none bg-transparent outline-none text-[13px] font-[400] placeholder-gray-500 duration-300 ${
          ...
          <button
            className="w-[36px] h-[36px] bg-white flex justify-center items-center rounded-full "
      ...
      {showSheet && (
        <div>
          <OrderDetails open={showSheet} onClose={() => setShowSheet(false)} />
        </div>
      )}
    </div>
  );
